...
La temática del proyecto consiste en la venta de **países ficticios**, pensada como una forma creativa y lúdica de practicar los conceptos aprendidos durante el módulo.
...
El proyecto fue desarrollado siguiendo el enfoque **mobile-first**, asegurando una correcta visualización tanto en dispositivos móviles como en pantallas de escritorio.
...
- **CSS3**
- **Bootstrap 5 (CDN)**
- **JavaScript (DOM, eventos, arrays y objetos)**
- **Git / GitHub**
